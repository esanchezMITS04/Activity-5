class CellphonesController < ApplicationController
  ...
  def decrement_stock
    ...
    @cellphone.Stock = @cellphone.Stock - 1
    @cellphone.save
  ...
  private
    ...
    def cellphone_params
      params.require(:cellphone).permit(:Name, :Brand, :Year_Released, :Camera, :Mpixel, :Internal_Storage, :No_Sim_Slot, :Size_of_Screen, :OS, :Stock)
    end
end
